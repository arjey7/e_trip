    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/tour/gettour","/api/tour/getAll","/api/tourDay/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/comment","/api/tourDay").permitAll()
                        .requestMatchers(HttpMethod.GET,"/api/comment/all","/api/comment/approved","/api/tour").permitAll()
