...
function getContext(){
    ...
    return (
        <div className={"all"}>
            ...
            <div className={"usus"} ref={aboutUsRef}>
                {page && page.length > 0 && (
                    <>
                            ...
                            {JSON.parse(item.abouts).map((about, aboutIndex) => (
                                <React.Fragment key={aboutIndex}>
                                    <div className="about-wrapper">
                                        <div>
                                            <span
                                                className="ccha">с</span>{moment(about.start_time).format('YYYY.MM.DD')}
                                            <span
                                                className="cchac">по</span>{moment(about.end_time).format('YYYY.MM.DD')}
